...
git clone https://github.com/216k155/seed.git
cd seed
...
```bash
    ...
    From https://github.com/216k155/seed
...
[seed/gitian.sigs](https://github.com/216k155/gitian.sigs/) repository, or if that's not possible to create a pull
request.
